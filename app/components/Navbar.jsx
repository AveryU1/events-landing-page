            ...
            <nav className='flex justify-between items-center w-full max-w-full h-24 p-4 fixed z-20 bg-[#0E121B]'>
                ...
                <div className='hidden lg:flex justify-center items-center'>
                    <ul className='hidden lg:flex flex-1 justify-end items-center gap-x-14 text-[#B7C1D8] text-sm md:text-lg'>
                        <li><a href="#about" className='flex flex-col-reverse justify-center items-center'>About Event</a></li>
                        <li><a href="#terms" className='flex flex-col-reverse justify-center items-center'>Terms</a></li>
                        <li><a href="#dress" className='flex flex-col-reverse justify-center items-center'>Dress Code</a></li>
                        <li><a href="#partners" className='flex flex-col-reverse justify-center items-center'>Partners</a></li>
                        <li><a href="#team" className='flex flex-col-reverse justify-center items-center'>Team</a></li>
                    </ul>
                </div>
                        ...
                        toggle && (
                            ...
                            <div className='fixed flex flex-col items-end top-0 right-0 bottom-0 left-0 w-full z-40 pt-8 bg-[#0E121B] px-4'>
                                ...
                                <ul className='flex flex-wrap m-0 p-0 w-full h-full items-center justify-center flex-col text-[#B7C1D8] text-sm'>
                                    <li onClick={() => setToggle(prev => !prev)} className="m-4 "><a href="#about">About Event</a></li>
                                    <li onClick={() => setToggle(prev => !prev)} className="m-4 "><a href="#terms">Terms</a></li>
                                    <li onClick={() => setToggle(prev => !prev)} className="m-4 "><a href="#dress">Dress Code</a></li>
                                    <li onClick={() => setToggle(prev => !prev)} className="m-4 "><a href="#partners">Partners</a></li>
                                    <li onClick={() => setToggle(prev => !prev)} className="m-4 "><a href="#team">Team</a></li>
                                    <button className='text-base text-white w-[145px] h-[45px] rounded-[50px] btn-gradient'>Contact us</button>
                                </ul>
                            </div>
                        )
